...
/* NS: Not ideal, but required to get this plugin to work when embedded into theme. */
//define('SCPORDER_URL', plugins_url('', __FILE__));
define('SCPORDER_URL', get_stylesheet_directory_uri().'/plugins/simple-custom-post-order/');
