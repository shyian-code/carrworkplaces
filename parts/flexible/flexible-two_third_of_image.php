...
<section class="content-module two-third-image <?php echo $background_color; ?>">
    <div class="l-wrapper">
        <?php if ($content_image || $content_description): ?>
            ...
            <div class="image-block <?php echo $image_position; ?>">
                <?php echo wp_get_attachment_image($content_image['id'], 'founder', false,
                      array('class' => 'two-third-image__photo'));
                ?>
            </div>
        <?php endif; ?>
    </div>
