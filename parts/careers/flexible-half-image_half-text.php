...
<section class="content-module l-wrapper career-half-text_half-image <?php echo $margin; ?>">
    <?php if ($content_image || $content_description): ?>
        <div class="block block-one <?php echo $position; ?>">
            <?php echo wp_get_attachment_image($content_image['id'], 'founder', false, array('class' => 'career-half-text_half-image__photo')); ?>
        </div>
